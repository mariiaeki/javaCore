        ...
        for (ParsedTransportation parsedTransportation : parsedTransportations) {
            ...
            if (cargo != null) {
                List<Transportation> transportations =
                        cargo.getTransportations() == null ? new ArrayList<Transportation>() : cargo.getTransportations();
            ...
            if (carrier != null) {
                List<Transportation> transportations =
                        carrier.getTransportations() == null ? new ArrayList<Transportation>() : carrier.getTransportations();
                transportations.add(transportation);
